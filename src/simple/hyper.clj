...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
  ...
  {:des "Hyper Mode"
   ...
   [;
    ; arrow glyphs
    ^{:doc/actions [{:program c/zj,    :action "page up",            :exec zj-swap-tab-left}]}     [(c/mk c/ihyper c/al) [(c/mk c/kspu)] :term]
    ^{:doc/actions [{:program c/zj,    :action "page down",          :exec zj-swap-tab-right}]}    [(c/mk c/ihyper c/ar) [(c/mk c/kspd)] :term]
    ^{:doc/actions [{:program c/zj,    :action "home",               :exec zj-size-inc}]}          [(c/mk c/ihyper c/au) [(c/mk c/kshm)] :term]
    ^{:doc/actions [{:program c/zj,    :action "end",                :exec zj-size-dec}]}          [(c/mk c/ihyper c/ad) [(c/mk c/ksed)] :term]
