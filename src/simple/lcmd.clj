  ...
  {:des "Command Mode"
   ...
   [;
    ...
    ^{:doc/actions [{:program c/hc,    :action "goto file start",    :exec hc-file-start}
                    ...
                    {:program c/ze,    :action "page up",            :exec ze-page-up}]}           [c/_au     [c/k_hm]   :term]
    ^{:doc/actions [{:program c/hc,    :action "goto file end",      :exec hc-file-end}
                    ...
                    {:program c/ze,    :action "page down",          :exec ze-page-down}]}         [c/_ad     [c/k_ed]   :term]

    ^{:doc/actions [{:program c/hc,    :action "select line start",  :exec hc-select-line-start}
                    {:program c/mc,    :action "select line start",  :exec mc-select-line-start}]} [c/kcs_al  [c/ko_al]  :term]
    ^{:doc/actions [{:program c/hc,    :action "select line end",    :exec hc-select-line-end}
                    {:program c/mc,    :action "select line end",    :exec mc-select-line-end}]}   [c/kcs_ar  [c/ko_ar]  :term]
    ^{:doc/actions [{:program c/hc,    :action "select file start",  :exec hc-select-file-start}
                    {:program c/mc,    :action "select file start",  :exec mc-select-file-start}]} [c/kcs_au  [c/ko_au]  :term]
    ^{:doc/actions [{:program c/hc,    :action "select file end",    :exec hc-select-file-end}
                    {:program c/mc,    :action "select file end",    :exec mc-select-file-end}]}   [c/kcs_ad  [c/ko_ad]  :term]

    ; technical glyphs
    ^{:doc/actions [{}]}                                                                           [c/kc_ob   [c/_ob]]
    ^{:doc/actions [{}]}                                                                           [c/kc_cb   [c/_cb]]
    ^{:doc/actions [{}]}                                                                           [c/kc_sc   [c/_sc]]
    ^{:doc/actions [{:program c/tm,    :action "terminal",           :sequence "`::<`"}]}          [c/kc_qu   [c/ks_sc c/ks_sc c/ks_cm]]
    ^{:doc/actions [{}]}                                                                           [c/kc_bl   [c/_bl]]
    ^{:doc/actions [{:program c/tm,    :action "terminal",           :sequence "' <- '"}]}         [c/kc_cm   [c/k_sp c/ks_cm c/k_hy c/k_sp]]
    ^{:doc/actions [{:program c/tm,    :action "terminal",           :sequence "` -> `"}]}         [c/kc_pe   [c/k_sp c/k_hy c/ks_pe c/k_sp]]
    ^{:doc/actions [{:program c/tm,    :action "terminal",           :sequence "`//! `"}]}         [c/kc_sl   [c/k_sl c/k_sl c/ks_1 c/k_sp]]

    ^{:doc/actions [{}]}                                                                           [c/kcsp_ob [c/ks_ob]]
    ^{:doc/actions [{}]}                                                                           [c/kcsp_cb [c/ks_cb]]
    ^{:doc/actions [{}]}                                                                           [c/kcsp_sc [c/ks_sc]]
    ^{:doc/actions [{}]}                                                                           [c/kcsp_qu [c/ks_qu]]
    ^{:doc/actions [{}]}                                                                           [c/kcsp_bl [c/ks_bl]]
    ...
    ; action glyphs
    ^{:doc/actions [{}]}                                                                           [c/kcp_db  [c/_db]]
    ^{:doc/actions [{}]}                                                                           [c/kcp_re  [c/_re]]
    ...
    ^{:doc/actions [{}]}                                                                           [c/kcp_sp  [c/_sp]]

    ^{:doc/actions [{}]}                                                                           [c/kcsp_db [c/ks_db]]
    ...
    ^{:doc/actions [{}]}                                                                           [c/kcsp_sp [c/ks_sp]]

    ; numeric glyphs
    ^{:doc/actions [{}]}                                                                           [c/kcp_1   [c/_1]]
    ^{:doc/actions [{}]}                                                                           [c/kcp_2   [c/_2]]
    ^{:doc/actions [{}]}                                                                           [c/kcp_3   [c/_3]]
    ^{:doc/actions [{}]}                                                                           [c/kcp_4   [c/_4]]
    ^{:doc/actions [{}]}                                                                           [c/kcp_5   [c/_5]]
    ^{:doc/actions [{}]}                                                                           [c/kcp_6   [c/_6]]
    ^{:doc/actions [{}]}                                                                           [c/kcp_7   [c/_7]]
    ^{:doc/actions [{}]}                                                                           [c/kcp_8   [c/_8]]
    ^{:doc/actions [{:program c/tm,   :action "terminal",         :sequence ".("}]}                [c/kcp_9   [c/k_pe c/ks_9]]
    ^{:doc/actions [{}]}                                                                           [c/kcp_0   [c/_0]]
    ...
    ^{:doc/actions [{}]}                                                                           [c/kcsp_1  [c/ks_1]]
    ^{:doc/actions [{}]}                                                                           [c/kcsp_2  [c/ks_2]]
    ^{:doc/actions [{}]}                                                                           [c/kcsp_3  [c/ks_3]]
    ^{:doc/actions [{}]}                                                                           [c/kcsp_4  [c/ks_4]]
    ^{:doc/actions [{}]}                                                                           [c/kcsp_5  [c/ks_5]]
    ^{:doc/actions [{}]}                                                                           [c/kcsp_6  [c/ks_6]]
    ^{:doc/actions [{}]}                                                                           [c/kcsp_7  [c/ks_7]]
    ^{:doc/actions [{}]}                                                                           [c/kcsp_8  [c/ks_8]]
    ^{:doc/actions [{:program c/tm,   :action "terminal",         :sequence "`:(`"}]}              [c/kcsp_9  [c/ks_sc c/ks_9]]
    ^{:doc/actions [{}]}                                                                           [c/kcsp_0  [c/ks_0]]
