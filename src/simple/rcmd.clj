...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
  ...
  {:des "Command Mode"
   ...
   [;
    ...
    ; technical glyphs
    ^{:doc/actions [{:program c/R,     :action "tidyverse",          :sequence "` %<+% `"}]}       [c/kqp_ob      [:spacebar :!S5 :!Scomma :!Sequal_sign :!S5 :spacebar]]
    ^{:doc/actions [{:program c/R,     :action "tidyverse",          :sequence "` %+>% `"}]}       [c/kqp_cb      [:spacebar :!S5 :!Sequal_sign :!Speriod :!S5 :spacebar]]
    ^{:doc/actions [{:program c/R,     :action "tidyverse",          :sequence "` %$% `"}]}        [c/kqp_sc      [:spacebar :!S5 :!S4 :!S5 :spacebar]]
    ^{:doc/actions [{:program c/R,     :action "tidyverse",          :sequence "` %T>% `"}]}       [c/kqp_qu      [:spacebar :!S5 :!St :!Speriod :!S5 :spacebar]]
    ^{:doc/actions [{:program c/R,     :action "tidyverse",          :sequence "` %<>% `"}]}       [c/kqp_bl      [:spacebar :!S5 :!Scomma :!Speriod :!S5 :spacebar]]
    ^{:doc/actions [{:program c/R,     :action "tidyverse",          :sequence "` %<% `"}]}        [c/kqp_cm      [:spacebar :!S5 :!Scomma :!S5 :spacebar]]
    ^{:doc/actions [{:program c/R,     :action "tidyverse",          :sequence "` %>% `"}]}        [c/kqp_pe      [:spacebar :!S5 :!Speriod :!S5 :spacebar]]
    ^{:doc/actions [{:program c/R,     :action "tidyverse",          :sequence "` %!>% `"}]}       [c/kqp_sl      [:spacebar :!S5 :!S1 :!Speriod :!S5 :spacebar]]
    ...
    ^{:doc/actions [{:program c/hc,    :action "save jump",          :exec hc-jump-save}]}         [c/kqp_sp      [:!TSf18]      :term]
    ^{:doc/actions [{:program c/hc,    :action "jump forward",       :exec hc-jump-forward}]}      [c/kqp_lc      [:!TSend]      :term]
    ^{:doc/actions [{:program c/hc,    :action "jumplist picker",    :exec hc-jump-picker}]}       [c/kqp_lo      [:!TSf12]      :term]
    ^{:doc/actions [{:program c/hc,    :action "jump backqard",      :exec hc-jump-backqard}]}     [c/kqp_lt      [:!TShome]     :term]
