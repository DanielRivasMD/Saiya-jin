...
(def alf "Alfred")
(def sys "System")
(def uay  "ubuntu-alacritty")
(def ubr  "ubuntu-broot")
(def umc  "ubuntu-micro")
(def uhc  "ubuntu-helix-common")
(def uhi  "ubuntu-helix-insert")
(def uhn  "ubuntu-helix-normal")
(def uhs  "ubuntu-helix-select")
(def xay  "macosx-alacritty")
(def xbr  "macosx-broot")
(def xmc  "macosx-micro")
(def xhc  "macosx-helix-common")
(def xhi  "macosx-helix-insert")
(def xhn  "macosx-helix-normal")
