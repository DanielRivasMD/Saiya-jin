...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
  ...
  {:des "Z mode"
   ...
   [:z-mode
    ...
    ; action glyphs
    ^{:doc/actions [{:program c/hc,    :action "goto prev diag",     :exec hc-prev-diag}]}         [a/kp_db       [:!Tf11]       c/term]
    ^{:doc/actions [{:program c/hc,    :action "diag picker",        :exec hc-diag-picker}]}       [a/kp_re       [:!Tf13]       c/term]
    ^{:doc/actions [{:program c/hc,    :action "goto next diag",     :exec hc-next-diag}]}         [a/kp_rs       [:!Tf12]       c/term]
    ^{:doc/actions [{}]}                                                                           [a/kp_ro       [a/k_ro]]
    ^{:doc/actions [{}]}                                                                           [a/kp_rc       [a/k_rc]]
    ^{:doc/actions [{:program c/hc,    :action "goto last change",   :exec hc-last-mod}]}          [a/kp_sp       [:!Tf15]       c/term]

    ^{:doc/actions [{}]}                                                                           [a/ksp_db      [a/ks_db]]
    ^{:doc/actions [{:program c/hc,    :action "wspace diag picker", :exec hc-diag-picker-ws}]}    [a/ksp_re      [:!Tf14]       c/term]
